...
function StandardFloor() {
  ...
  const rooms: RoomType[] = [
    {
      ...
      capacity: 2,
      size: 14,
      beds: t('rooms.beds.large_double'),
      view: [
        t('rooms.view.garden'),
        t('rooms.view.city'),
      ...
      image: images.rooms.standard.room1,
      gallery: [
        images.rooms.standard.room1,
    ...
    },
    {
      ...
      image: images.rooms.standard.room2,
      gallery: [
        images.rooms.standard.room2,
        images.common.bathroom1,
        images.common.bathroom2,
        images.common.hallway
      ]
    },
    {
      ...
      image: images.rooms.standard.room3,
      gallery: [
        images.rooms.standard.room3,
        images.common.bathroom1,
        images.common.bathroom2,
        images.common.hallway
      ]
  ...
  const kitchenFeatures = [
    {
      ...
      title: t('standardFloor.kitchen.basicAppliances.title'),
      description: t('standardFloor.kitchen.basicAppliances.description')
    },
    {
      icon: <UtensilsCrossed className="w-6 h-6 text-yellow-600" />,
      title: t('standardFloor.kitchen.sharedSpace.title'),
      description: t('standardFloor.kitchen.sharedSpace.description')
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div style={{ 
        backgroundImage: `url(${images.rooms.standard.room1})`,
        ...
        <div className="bg-black bg-opacity-50">
          ...
          <div className="max-w-7xl mx-auto px-4 py-20 text-white">
            <h1 className="text-5xl font-serif mb-4">{t('standardFloor.title')}</h1>
            <p className="text-xl opacity-90">{t('standardFloor.subtitle')}</p>
          </div>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-serif mb-6">{t('standardFloor.kitchen.title')}</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="relative h-[300px]">
                <img 
                  ...
                  alt={t('standardFloor.kitchen.title')}
